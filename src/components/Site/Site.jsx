...
import {
  productPurchaseCountState,
  activeUserCountState,
  imageListState,
} from "../../RecoilState/RecoilState";

export default function Conversation() {
  const [productPurchaseCount, setProductPurchaseCount] = useRecoilState(
    productPurchaseCountState
  );
  const [activeUserCount, setActiveUserCount] =
    useRecoilState(activeUserCountState);
    ...
    <>
      <div className="system flex justify-between mt-[100px] mr-[50px]">
        <div className="w-[620px] h-[370px]">
          <h1 className="text-[40px] font-[800] mb-[20px]">سیستم سایت فروش</h1>
